...
export default function GeminiChatbot() {
  ...
  const faqList = [
    {
      ...
      answer: "Bạn nhấp vào nút “Đăng ký” ở góc trên bên phải, điền họ tên, email, số điện thoại, địa chỉ, ngày sinh, mật khẩu rồi bấm “Đăng ký”.",
    },
    {
      question: "Chưa biết nhóm máu có đăng ký hiến được không?",
      answer: "Được. Chọn “Đăng kí hiến máu”, sau đó ra cơ sở xét nghiệm miễn phí và gửi kết quả cho nhân viên y tế xác minh.",
    },
  ...
  return (
    <>
      {!open && (
        <button style={iconBtnStyle} onClick={() => setOpen(true)} title="Mở chatbot hỗ trợ hiến máu">
      ...
      {open && (
        <div style={{
          ...
          background: "#fff", borderRadius: 12, boxShadow: "0 2px 16px #0003", padding: 0, zIndex: 1000, overflow: "hidden"
        }}>
          {/* Header */}
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div>
                <div style={{ color: "#fff", fontWeight: "bold", fontSize: 18 }}>DaiVietBlood Chatbot</div>
          ...
          {/* Nội dung chat */}
          <div style={{
            height: 220, overflowY: "auto", background: "#f9f9f9", padding: 12, display: "flex", flexDirection: "column", gap: 8
          }}>
            {messages.map((msg, i) => (
              <div key={i} style={{
                display: "flex",
                ...
                <img
                  ...
                  alt={msg.from}
                  style={{ width: 28, height: 28, borderRadius: "50%", background: "#fff" }}
                />
                <div style={{
            ...
            {loading && (
              <div style={{ color: "#888", fontStyle: "italic", marginLeft: 36 }}>Đang trả lời...</div>
            )}
          </div>
          {/* Gợi ý câu hỏi */}
          <div style={{
            display: "flex", gap: 8, overflowX: "auto", padding: "8px 12px", background: "#fff"
          }}>
          ...
          {/* Input */}
          <div style={{
            display: "flex", gap: 8, padding: "10px 12px", background: "#fff", borderTop: "1px solid #f1f1f1"
          }}>
            <input
              style={{
                flex: 1, borderRadius: 20, border: "1px solid #ccc", padding: "8px 14px",
            ...
            <button
              style={{
                background: "#D32F2F", color: "#fff", border: "none", borderRadius: "50%",
                width: 40, height: 40, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18
              }}
              onClick={() => handleSend()}
              disabled={loading}
              title="Gửi"
