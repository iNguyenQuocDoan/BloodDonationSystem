        ...
        <div className="w-full max-w-md relative z-10">
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
            <div className="text-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-[#D32F2F]">Đăng Ký</h2>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#D32F2F] focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white ${
